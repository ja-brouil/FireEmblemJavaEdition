...
public class TerrainInfoBox extends MenuBox {
	...
	public TerrainInfoBox(MapCursor mapCursor, AssetManager assetManager, Engine engine) {
	...
	public void update(MapCursor mapCursor) {
		...
		textComponent.textArray.get(2).text = Integer.toString((int) MovementUtilityCalculator.getMapCellStatic(mapCursor.getMapCursorEntity()).avoidanceBonus);
		textComponent.textArray.get(4).text = Integer.toString((int) MovementUtilityCalculator.getMapCellStatic(mapCursor.getMapCursorEntity()).defenceBonus);
